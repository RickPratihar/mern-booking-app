        ...
        <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
          <div className="w-full lg:w-6/12">
            <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
              We're here to make unforgettable stays accessible and delightful
              for everyone.
            </h2>
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              It is a long established principle that travelers may become
              distracted by the layout and content of a webpage when seeking
              information. Here at [Your Hotel Booking Website Name], we uphold
              the belief that every traveler should have access to a seamless
              and enjoyable booking experience. Just as it has been granted that
              the English Church shall have its rights preserved, we are
              committed to ensuring that your rights as a traveler are upheld,
              providing you with the freedom to explore and book your ideal
              accommodations with ease and satisfaction.
            </p>
          </div>
          <div className="w-full lg:w-6/12">
            <img
        ...
        <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
          <div className="w-full lg:w-6/12">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
              At DreamStay Hub, our mission is to redefine hospitality by
              crafting exceptional experiences that leave a lasting impression.
              We strive to create a welcoming haven where every guest feels
              valued and cherished, where comfort and luxury converge
              seamlessly. Our dedicated team is committed to exceeding
              expectations, from the warm greeting at check-in to the
              personalized service throughout your stay. With meticulous
              attention to detail and a passion for hospitality, we aim to
              inspire moments of joy and relaxation, fostering unforgettable
              memories for each and every guest who walks through our doors. At
              the heart of our mission lies a commitment to excellence, ensuring
              that every aspect of your experience embodies our core values of
              warmth, professionalism, and genuine care.
            </p>
            <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">
              Beyond providing luxurious accommodations and unparalleled
              service, we aspire to be more than just a destination; we aim to
              be a cherished memory in the hearts of our guests. Whether you're
              here for business or leisure, our mission is to create an
              environment where you can thrive and indulge in the pleasures of
              travel. From innovative amenities to thoughtful touches, we
              continuously seek ways to elevate your experience and make your
              stay truly extraordinary. At DreamStay Hub, our mission isn't just
              about providing a place to stay—it's about creating a home away
              from home, where every moment is crafted with care and every guest
