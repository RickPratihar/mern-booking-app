const Footer = () => {
  return (
    // <div classNameName='bg-blue-800 py-10 '>
    //     <div classNameName="mx-auto flex justify-around items-start">
    //         <span classNameName="sm:text-xl md:text-3xl text-white font-bold tracking-tight">
    //             Holiday-Booking.com
    //         </span>
    //         <span classNameName="sm:text-sm md:text-xl text-white font-bold tracking-tight flex gap-4">
    //         <p classNameName="cursor-pointer">Privacy Policy</p>
    //         <p classNameName="cursor-pointer">Terms of Services</p>
    //         </span>
    //     </div>
    // </div>
    <>
      <footer className="flex flex-col items-center text-center text-surface bg-blue-800 py-10 ">
        <div className="container px-6 pt-6">
          ...
          <div>
            <form action="">
              <div className="gird-cols-1 grid items-center justify-center gap-4 md:grid-cols-3">
                ...
                <div
                  className="relative md:mb-6 border-black"
                  data-twe-input-wrapper-init
                >
                  <input
                    type="email"
                    className=" w-full rounded border-0 bg-transparent px-3 py-[0.32rem] outline-none  bg-white"
                    id="exampleFormControlInputEmail"
                    placeholder="Email address"
                  />
                  <label
                    htmlFor="exampleFormControlInputEmail"
                    className="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6]  transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[twe-input-state-active]:-translate-y-[0.9rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none "
                  >
                  </label>
                </div>
                ...
                <div className="mb-6 md:me-auto">
                  <button
                    className="w-full flex items-center justify-center px-5 py-2 text-base leading-6
          ...
          <div className="mb-6 text-white">
            <p>
              Unlock your dream getaway with our curated selection of hotels
              worldwide. Book now for unbeatable rates, seamless reservations,
              and unforgettable experiences. Your journey begins with us.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4">
            <div className="mb-6">
              <h5 className="mb-2.5 font-bold uppercase text-white">Customar Service Help</h5>
            ...
            <div className="mb-6">
              <h5 className="mb-2.5 font-bold uppercase text-white">Make changes online to your booking </h5>
            ...
            <div className="mb-6">
              <h5 className="mb-2.5 font-bold uppercase text-white"> Become an affiliate </h5>
            ...
            <div className="mb-6">
              <h5 className="mb-2.5 font-bold uppercase text-white">Holiday-Booking.com for Business</h5>
        ...
        <div className="w-full bg-black/15 p-4 text-center text-white">
          © 2024 Copyright:
          <a className="font-semibold" href="http://rickpratihar-portfolio.netlify.app/">
            Rick Pratihar
          </a>
        </div>
      </footer>
