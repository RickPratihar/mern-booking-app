  ...
  return (
    ...
    >
      <img
        ...
        alt=""
      />
      <div className="bg-white p-8 rounded-tr-lg rounded-br-lg w-[60%] h-[25%] md:w-[18%] md:h-[43.5%]">
        <i
          className="fa-solid fa-xmark ml-[46%] top-[38%] md:ml-[14.5%] md:top-[28.2%] absolute text-3xl cursor-pointer"
          onClick={handleClose}
        ></i>
        <h2 className="text-2xl font-bold mb-4">Special Discount!</h2>
        <p className="text-lg mb-4">Get 20% off on your next Booking.</p>
